    ...
    <div class="dates" ref="dates">
      <div class="dates-bg">
        <div class="week-row" v-for="week in currentDates" :key="week">
          <div class="day-cell" v-for="day in week" :key="day"
      ...
      <div class="dates-events">
        <div class="events-week" v-for="week in currentDates" :key="week">
          <div class="events-day" v-for="day in week" track-by="$index" :key="day"
            :class="{'today' : day.isToday,
              'not-cur-month' : !day.isCurMonth}" @click.stop="dayClick(day.date, $event)">
            <p class="day-number">{{day.monthDay}}</p>
            <div class="event-box">
              <p class="event-item" v-for="event in day.events" :key="event" v-show="event.cellIndex <= eventLimit"
